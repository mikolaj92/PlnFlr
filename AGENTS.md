...
- Product north star and safety boundary: `SOUL.md`. Every house should have one faithful 3D map; floors work on room/storey/whole-home selections. Hidden utilities are never inferred from missing data: provenance and confidence must be explicit; no unverified drill-safety claim.
