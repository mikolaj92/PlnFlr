...
- Geometry is integer millimetres. Parse metres with `Decimal`. Live kernel: `pyclipper`. Swift kernel: `Kernel/` (`PlnFlrLayout`, iOS 16 / macOS 14). Vapor 5 is the future web host, not the kernel.
